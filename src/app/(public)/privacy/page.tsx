...
export const metadata: Metadata = {
  title: "Privacy Policy — ContractorCalc",
};
        ...
        <div className="prose prose-sm dark:prose-invert space-y-6 text-foreground">
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              When you use ContractorCalc, we store the data you provide including customer information,
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              We use your information to provide and improve ContractorCalc, send transactional emails
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              changes via email or in-app notification. Continued use of ContractorCalc after changes
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              For privacy-related questions, contact us at support@contractorcalc.com.
            </p>
          </section>
        </div>
      </div>
