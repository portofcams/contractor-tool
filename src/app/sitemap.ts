...
const ROUTES: Array<{
  ...
  { path: "/tools/window-calculator", priority: 0.8, changeFrequency: "monthly" },
  { path: "/tools/mortar-calculator", priority: 0.8, changeFrequency: "monthly" },
  { path: "/tools/pex-pipe-calculator", priority: 0.8, changeFrequency: "monthly" },
  { path: "/tools/framing-cost-calculator", priority: 0.8, changeFrequency: "monthly" },
  { path: "/tools/driveway-cost-calculator", priority: 0.8, changeFrequency: "monthly" },
  { path: "/tools/bathroom-tile-calculator", priority: 0.8, changeFrequency: "monthly" },
  { path: "/tools/wood-fence-cost-calculator", priority: 0.8, changeFrequency: "monthly" },
  { path: "/tools/shed-calculator", priority: 0.8, changeFrequency: "monthly" },
  { path: "/for", priority: 0.7, changeFrequency: "monthly" },
  { path: "/for/roofers", priority: 0.7, changeFrequency: "monthly" },
  { path: "/for/tile-setters", priority: 0.7, changeFrequency: "monthly" },
  { path: "/for/landscapers", priority: 0.7, changeFrequency: "monthly" },
  { path: "/for/siding-contractors", priority: 0.7, changeFrequency: "monthly" },
